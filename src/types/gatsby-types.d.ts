...
type EntryPageQueryQueryVariables = Exact<{
  id: Scalars['String'];
}>;


type EntryPageQueryQuery = { readonly markdownRemark: { readonly rawMarkdownBody: string | null, readonly frontmatter: { readonly date: string | null, readonly slug: string | null, readonly title: string | null, readonly draft: boolean | null, readonly tags: ReadonlyArray<string | null> | null } | null } | null, readonly site: { readonly siteMetadata: { readonly title: string | null, readonly description: string | null, readonly siteUrl: string | null } | null } | null };
...
type IndexPageQueryQuery = { readonly allMarkdownRemark: { readonly edges: ReadonlyArray<{ readonly node: { readonly html: string | null, readonly frontmatter: { readonly date: string | null, readonly slug: string | null, readonly title: string | null, readonly draft: boolean | null, readonly tags: ReadonlyArray<string | null> | null } | null } }> }, readonly allTags: { readonly edges: ReadonlyArray<{ readonly node: { readonly frontmatter: { readonly tags: ReadonlyArray<string | null> | null } | null } }> } };

type TagArticlesPageQueryQueryVariables = Exact<{
  tag: Scalars['String'];
  skip: Scalars['Int'];
  limit: Scalars['Int'];
}>;
...
type TagArticlesPageQueryQuery = { readonly allMarkdownRemark: { readonly edges: ReadonlyArray<{ readonly node: { readonly html: string | null, readonly frontmatter: { readonly date: string | null, readonly slug: string | null, readonly title: string | null, readonly draft: boolean | null, readonly tags: ReadonlyArray<string | null> | null } | null } }> } };
