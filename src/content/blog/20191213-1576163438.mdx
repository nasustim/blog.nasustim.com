...
import bike01 from '@/content/assets/20191213-1576163438/20190512160014.jpg';
import bike02 from '@/content/assets/20191213-1576163438/20191212205618.jpg';
import bike03 from '@/content/assets/20191213-1576163438/20191212223856.jpg';
...
<Picture formats={["avif", "webp"]} src={bike01} alt="図1: YAMAHA ルネッサ" />
...
<Picture formats={["avif", "webp"]} src={bike02} alt="図2: 機構がむき出し" />
...
<Picture formats={["avif", "webp"]} src={bike03} alt="図3: ライダーは心が健康" />
